...
<html>
    <head>
        ...
        <title>Cancel - Atonal Records</title>
        ...
        <link href="../css/cancel.css" rel="stylesheet" type="text/css"/>								
            ...
            $(document).ready(function() {
                $("#cancellationForm").validate({
                    ...
                    submitHandler: function(){
                        var radio = document.querySelector('input[name="reason"]:checked').value;
                        ...
                        $.ajax({
                            ...
                            crossDomain: true,
                            method: 'GET',
                            url: 'service/cancellation.php',
                            data: {reason: radio},
                            success: function(data){
                                if(data === 'success')
                                {
                                    M.toast({html: 'Cancelation reason submitted', classes: 'green'});
                                }
                                else if(data === 'return')
                                {
                                    M.toast({html: 'Cancelation reason for this purchase already submitted', classes: 'orange'});
                                }
                                else
                                {
                                    M.toast({html: 'An error occured, please try again later', classes: 'red'});
                                }
                            }
                        });
                    }
    ...
    <body onload="year();">
        <div id="modal-authorization" class="modal">
            <div class="modal-content grey-text">
                <div class="row">
                    <div class="col l6">
                        <div class="input-field"><h6>Login to your account</h6></div>
                        <form id="loginForm">
                            ...
                            <div class="input-field">
                                <button class="btn btn-round waves-effect waves-light grey submit" id="loginBtn">LOG IN</button>
                                <a href="../secure/password-recovery" id="forgot-password" class="btn btn-flat waves-effect waves-light grey-text">Forgot your password?</a>
                            </div>
                        </form>
                    </div>
                    <div class="col l6">
                        ...
                        <p>Become a member?</p>
                        <button class="btn btn-round waves-effect waves-light grey white-text" onclick="window.location.href = '../secure/register'">Register</button>
        ...
        <div class="navbar-fixed">
            <nav class="nav-wrapper white z-depth-0">
                <div>
                    <a class="brand-logo hide-on-med-and-down" href="../site/index"><img src="../images/logo.png" alt="logo" class="brand-logo-64"></a>
                    <a class="brand-logo hide-on-large-only" href="../site/index"><img src="../images/logo.png" alt="logo" class="brand-logo-56"></a>
                    <a class="sidenav-trigger show-on-medium-and-up" data-target="sidenav"><i class="material-icons" >menu</i></a>
                    <ul class="hide-on-med-and-down">
                        <div class="right">
                            <li>
                                <a href="#" id="nav-ul-li-profile" class="hide dropdown-trigger" data-target="dropdown-account"><i class="fa fa-user fa-1x"></i></a>
                            ...
                            <li>
                                <a href="../secure/library"><i class="fa fa-cloud-download-alt fa-1x"></i></a>
                            </li>
                            <li>
                                <a href="#" id="modal-authorization-trigger" class="btn waves-effect waves-light grey white-text"></a>
                            </li>
                        </div>
                    </ul>
                </div>
        ...
        <div class="navbar-fixed bottom hide-on-med-and-up z-index-4">
            <nav class="nav-wrapper override-position white">
                <div class="container">
                    <ul class="hide-on-med-and-up">
                        <li>
                            <a href="../secure/account" id="bottom-profile" class="modal-trigger"><i class="fa fa-user fa-1x"></i></a>
                        </li>
                        <li>
                            <a href="../secure/cart">
                                <span class="pin-top">
                        ...
                        <li>
                            <a id="nav-ul-li-a-logout-2nd-child" href=""><i class=""></i></a>
                        </li>
                    </ul>                  
                </div>
            </nav>
        ...
        <ul class="sidenav" id="sidenav">
            <a class="brand-logo" href="index"><img src="../images/menu.png" class="responsive-img" alt="logo"></a>
            <li><a href="index" class="waves-effect waves-light">Explore</a></li>
                ...
                <div class='row'>
                    <div class='col s12 l12'>
                        <form method="POST" id="cancellationForm">
                            <p>
                                <label>
                                    <input name="reason" type="radio" value="Its too costly" data-error=".reason" class="red-text">
                                    <span>Its too costly</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                    <input name="reason" type="radio" value="Took too long to process the transaction" data-error=".reason">
                                    <span>Took too long to process the transaction</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                    <input name="reason" type="radio" value="Preferred payment option not available" data-error=".reason">
                                    <span>Preferred payment option not available</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                    <input name="reason" type="radio" value="I changed my mind" data-error=".reason">
                                    <span>I changed my mind</span>
                                </label>
                            </p>
                            <p>
                                <label>
                                    <input name="reason" type="radio" value="Other" data-error=".reason">
                                    <span>Other</span>
                                </label>
                            </p>
                            ...
                            <p>
                                <button type="submit" class="btn btn-round waves-effect grey submit" name="continue">Continue</button>
                            </p>
                        </form>
                    </div>
                </div>
