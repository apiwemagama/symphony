...
<html>
    ...
    <body onload="year()">
        <div class='container'>
            <div class="h-10 valign-wrapper">
                <img src='../../images/site/icon.png' class="w-10">
                <h5 class="grey-text">API Manager</h5>
            </div>
            <h4 class="grey-text">Unauthorized Access</h4>
            <p class="grey-text">We apologize for the inconvinience, but you are not authorized to visit this page. If you believe this is an error, please contact your account manger.</p>
        </div>
        <footer class='grey page-footer'>
            ...
            <div class='footer-copyright'>
                <div class='container center-align white-text'>&copy; <span id='year'>2024</span> Atonal Records. All Rights Reserved.</div>
            </div>
        </footer>
    </body>
</head>